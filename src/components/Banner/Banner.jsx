                    ...
                    <div className="container">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col justify-center gap-6 sm:pt-0">
                                ...
                                >
                                    Our Offer is about to end ,
                                     you can buy 2 and get 1 free.

                  <br />
                                    <br />
                                    Protein is an important nutrient, but burgers offer way more than that.
                                     Whenever you eat a burger, you'll also give your body B-vitamins,
                                     iron, zinc, niacin, and other vitamins and minerals.
